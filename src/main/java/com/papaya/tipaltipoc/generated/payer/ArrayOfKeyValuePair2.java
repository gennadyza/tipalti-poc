 ...
 *       &lt;sequence&gt;
 *         &lt;element name="KeyValuePair" type="{V8}KeyValuePair" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfKeyValuePair", namespace = "V8", propOrder = {
    "keyValuePair"
})
public class ArrayOfKeyValuePair2 {

    @XmlElement(name = "KeyValuePair", nillable = true)
    protected List<KeyValuePair2> keyValuePair;
     ...
     * 
     */
    public List<KeyValuePair2> getKeyValuePair() {
        if (keyValuePair == null) {
            keyValuePair = new ArrayList<KeyValuePair2>();
        }
